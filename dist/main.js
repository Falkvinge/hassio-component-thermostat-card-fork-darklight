import {cssData} from './styles.js?v=0.1.12';
import ThermostatUI from './thermostat_card.lib.js?v=0.1.12';
console.info("%c Thermostat Card (darklight fork) \n%c  Version  0.1.12 ", "color: orange; font-weight: bold; background: black", "color: white; font-weight: bold; background: dimgray");
